...
# -------------------------------------------------------------
# AUTOMATIC DEPENDENCY CHECKER (Fixes ModuleNotFoundError)
# -------------------------------------------------------------
REQUIRED_MODULES = {
    "xgboost": "xgboost",
    "flask": "flask",
...
for module_name, pip_name in REQUIRED_MODULES.items():
    try:
        ...
        try:
            ...
            print(f"Please open your terminal and run: pip install {pip_name}")

# Now safe to import libraries without crashing
...
def predict():
    if model is None:
        return render_template_string(HTML_TEMPLATE, features=FEATURE_MAPPING, error="Model file configuration is missing on this server instance.")
    ...
    try:
        ...
        # Calculate probabilities dynamically if model supports it
        ...
        # Standard Target Variable Output Mapping Configuration
        result_mapping = {
            0: {
